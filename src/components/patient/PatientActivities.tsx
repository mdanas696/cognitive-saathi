    ...
    <div className="space-y-6 sm:space-y-8 animate-fadeIn">
          ...
          >
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1 text-xs text-stone-500 font-medium">
                  ...
                  <span>{game.estimatedMinutes} {t.minutesUnit}</span>
                </div>
              </div>
            ...
            <div className="pt-6 border-t border-stone-100 mt-4">
              <button
                ...
                className="w-full flex items-center justify-center gap-2.5 py-4 px-6 rounded-2xl bg-teal-800 hover:bg-teal-900 text-white font-bold text-base shadow-sm hover:shadow transition active:scale-98 min-h-[52px]"
      ...
      <div className="rounded-2xl bg-stone-100 p-5 text-stone-700 flex items-start gap-3 border border-stone-200">
        ...
        <p className="text-xs sm:text-sm leading-relaxed">
          <strong>Elderly-Friendly Tip:</strong> These activities adapt naturally to your comfort. There is no countdown timer, no score penalty, and you can pause or replay anytime.
        </p>
      </div>
    </div>
  );
